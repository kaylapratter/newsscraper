...
# COMPLETE EXTRACTED PUBLICATION ARCHIVE DIRECTLY FROM WEEKLYCITIZEN.CO.KE
...
def fetch_all_weekly_citizen_posts():
    print(f"Loading full extracted publication archive of {len(ALL_WEEKLY_CITIZEN_STORIES)} Weekly Citizen stories...")
